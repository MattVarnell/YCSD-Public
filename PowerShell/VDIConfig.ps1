...
.DESCRIPTION
    This script configures Windows 10 with minimal configuration for VDI.
.NOTES
    Author: Carl Luberti updated by Matt Varnell for YCSD Settings
#>
...
$EAPService = "False"
#Enable / Disable EAP (802.1x or NAP) Service
$EFS = "True"
#Enable / Disable  EFS (Encrypting File System) Service
$FileHistoryService = "True"
#FileHistory copies files to backup folder
$iSCSI = "True"
#install iSCSI drivers
$MachPass = "True"
#disable Change Computer Password
$MSSignInService = "True"
#Disable MS Signing (Microsoft Account)
$OneDrive = "False"
#Enable / Disable OneDrive
$PeerCache = "False"
#Allow BITS peering in same ADDS site
$Search = "False"
#Enable / Disable Search Service
$SMB1 = "True"
#Enable / Disable SMB1
$SMBPerf = "True"
#Enable SMB Perf Tweaks
$Themes = "True"
#Enable / Disable Themes
$Touch = "True"
#Enable / Disable Touch Keyboard
$StartApps = "True"
#Enable / Disable UWP Apps
$StoreApps = "True"
#Enable / Disable Builtin Store Apps

$Install_NetFX3 = "True"
$NetFX3_Source = "\\Path\MDT\Operating Systems\Windows 10 Enterprise1607  x64\sources"
#Enable / Disable DotNet3
$RDPEnable = 1
$RDPFirewallOpen = 1
$NLAEnable = 1
#Enable / Disable RDP and Firewall / NLA
...
# Set PeerCaching to Disabled (0) or Local Network PCs only (2):
...
Else
{
    ...
    Write-Host ""
    Set-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DeliveryOptimization\Config' -Name 'DODownloadMode' -Value '2'
}
...
If ($AppV -eq "False")
{
    Write-Host "Enabling AppV Service..." -ForegroundColor Yellow
    Enable-Appv
}
...
#Disable NetBios for All Network Adapters
Clear-Host
...
$adapter=(gwmi win32_networkadapterconfiguration | where {$_.ipenabled -eq "1"})
Foreach ($nic in $adapter) {
write-host NetBIOS is now -> $adapter.TcpIPNetBiosOptions
}
